  ...
  return (
      <div className={ TabState.showSideBar ? "SidebarGroup Compact MobileSidebar" : "SidebarGroup"}>
        ...
        <div className="SidebarList">
          ...
          <Link className = "link" to="/" onClick={(e)=>{TabState.closeSideBar(e)}}>
          ...
          <Link className = "link" to="/Trade" onClick={(e)=>{TabState.closeSideBar(e)}}>
          ...
          <Link className = "link" to="/Earn" onClick={(e)=>{TabState.closeSideBar(e)}}>
          ...
          <Link className = "link" to='/Market' onClick={(e)=>{TabState.closeSideBar(e)}}>
          ...
          <Link className = "link" to="Derivatives" onClick={(e)=>{TabState.closeSideBar(e)}}>
          ...
          <Link className = "link" to="Settings" onClick={(e)=>{TabState.closeSideBar(e)}}>
